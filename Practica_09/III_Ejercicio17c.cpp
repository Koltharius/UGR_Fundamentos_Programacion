...
class Recta{
   ...
   public:
      ...
      double Set_coef_X(double coef_x){
         A = coef_x;
      }

      double Set_coef_Y(double coef_y){
         B = coef_y;
      }

      double Set_coef_indep(double coef_indep){
         C = coef_indep;
      }
...
int main() {
   ...
   primera_recta.Set_coef_X(coef_x_primera_recta);
   primera_recta.Set_coef_Y(coef_y_primera_recta);
   primera_recta.Set_coef_indep(coef_z_primera_recta);

   segunda_recta.Set_coef_X(coef_x_segunda_recta);
   segunda_recta.Set_coef_Y(coef_y_segunda_recta);
   segunda_recta.Set_coef_indep(coef_z_segunda_recta);
